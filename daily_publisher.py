...
def generate_caption():
    ...
    fallback_titles = [
        "When Two Girls Start Roasting Everyone at the Coffee Shop",
        "These Two Just Destroyed Every Boyfriend in the Room",
        "The Most Savage Girl Talk You'll Ever Hear",
        "When Your Best Friend Starts Roasting Your Life Choices",
        "POV: Two Girls at Coffee Having the Most Brutal Conversation",
        "These Friends Have No Filter and We Love It",
        "The Hilarious Girl Talk Compilation That Broke the Internet",
        "When Women Support Women (By Roasting Everyone Else)",
        "These Two Girls Are the Funniest Duo on the Internet",
        "The Unfiltered Girl Talk That Everyone Needs to Hear"
    ]
    fallback_descriptions = [
        "When two best friends get together at a coffee shop, you know the conversation is legendary. This video captures the most hilarious, unfiltered, and savagely funny moments between these two girls as they roast boyfriends, life choices, and everything in between. The chemistry is unmatched, the timing is perfect, and the honesty is refreshingly brutal. This is real friendship - where you can say anything and still be best friends.",
        "There's nothing more entertaining than two best friends with zero filter and a lot of opinions. This kaffemate bugs duo brings the most hilarious, unapologetically honest comedy to your feed. From roasting terrible boyfriends to calling out life's most absurd moments, these two don't hold back. The natural chemistry, perfectly timed jokes, and savage observations - this is comedy at its most authentic."
    ]
    if not api_key:
        return random.choice(fallback_titles), random.choice(fallback_descriptions)
    vibes = [
        "savage and unfiltered",
        "relatable and funny",
    ...
    prompt = (
        ...
        f"for Facebook page 'KaffeMate Bugs'. "
        f"Page posts two girls having funny conversations, roasting people and boyfriends over coffee. "
        f"Speak as a coffee shop regular loving these girls' hilarious conversation. Vibe: {chosen_vibe}. "
        f"Description 4-6 sentences, engaging. Include: Like if this is how you and your bestie talk! Comment funniest friend moment! Follow KaffeMate Bugs! "
        f"Hashtags: #girls #coffee #friendship #roast #funny #savage #bestfriends #hilarious #viral #trending. "
...
def main():
    ...
    try:
        upload_to_youtube(video_path, title, description, tags=["girls", "coffee", "friendship", "roast", "funny", "savage", "bestfriends", "hilarious", "viral", "trending"])
        sf["youtube"] = True
    except: pass
